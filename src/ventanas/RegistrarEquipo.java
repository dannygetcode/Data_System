...
public class RegistrarEquipo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmb_tipoequipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptop", "Desktop", "Impresora", "Multifuncional", "Monitor" }));
        ...
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, -1, -1));
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "¡Error al registrar quipo, contacte con el administrador!");
            }
