...
public class GraficarMarcas extends javax.swing.JFrame {
    ...
    public GraficarMarcas() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select marca, count(marca) as Marcas from group by marca");
            ...
            JOptionPane.showMessageDialog(null, "Error en la consulta de datos, contacte al administrador");
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, -1, -1));
    ...
    public void paint(Graphics g) {
        ...
        // Marca Toshiba, Color Amarillo Canario
        ...
        // Marca Xerox, Color Amarillo Azul Celeste
