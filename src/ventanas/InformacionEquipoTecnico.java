...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 460, -1, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        try {
            ...
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
                    "update equipos set estatus=?, comentarios_tecnicos=?, revision_tenica_de=? where id_equipo = '" + IDequipo + "'");
            ...
            System.err.println("Erroe en actualizar equipo" + e);
