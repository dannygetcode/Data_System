...
public class GraficarEstatus extends javax.swing.JFrame {
    ...
    public GraficarEstatus() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro, contacte al administrador!");
        }
    ...
    public void paint(Graphics g){
        ...
        //tamaño para determinar la barra de la graficas
        ...
        g.setColor(new Color(255, 248, 0));// rojo
        g.fillRect(100, 150, largo_NoReparado, 40);
        g.drawString("No Repadaro", 10, 168);
